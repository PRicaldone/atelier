  ...
  return (
    <div>
      <motion.div
        ...
        className="mb-8"
      >
        <h2 className="text-2xl font-semibold text-gray-900">Business Mode</h2>
        <p className="mt-1 text-gray-600">Switch between different creative workflows</p>
      </motion.div>
      ...
      >
        <p className="text-sm text-gray-600">
          Current mode: <span className="font-semibold text-gray-900">{businessMode.toUpperCase()}</span>
        </p>
      </motion.div>
    </div>
  );
