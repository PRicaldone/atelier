...
case $choice in
    1)
        ...
        rsync -av --exclude='*/node_modules' --exclude='.DS_Store' --exclude='*.log' atelier/ ATELIER-VERSIONS/v1.x-$DATE/
    ...
    3)
        ...
        tar -czf ATELIER-BACKUPS/milestone-$milestone_name-$DATE.tar.gz atelier/
