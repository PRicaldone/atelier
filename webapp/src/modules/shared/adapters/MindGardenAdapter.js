 ...
 * @ucaVersion 1.0.0
 * @ucaCapabilities auto-recognition, preview, file-awareness
 * @ucaContentTypes text, markdown, code, image
 * @ucaDescription Enables content awareness for mind mapping nodes and connections
 */
