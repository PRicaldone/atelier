  ...
  return (
    <div>
      <motion.div
        ...
        className="mb-8"
      >
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Project Tracker</h2>
        <p className="mt-1 text-gray-600 dark:text-gray-300">Monitor and manage all your projects</p>
      </motion.div>
