...
**Data:** 11/07/2025 12:27
**Ultimo commit:** 0dc5331 ✅ DRAG&DROP Canvas→Tree PERFETTO! Drop Canvas→Canvas ancora duplica - fix parziale ma significativo
**Branch:** main
**Commit totali:** 36
**Snapshots:** 29 | **Backups:** 0

**Ultima modifica:** ✅ DRAG&DROP Canvas→Tree PERFETTO! Drop Canvas→Canvas ancora duplica - fix parziale ma significativo
