...
const VisualCanvas = () => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-50" style={{ top: '64px', left: '240px', right: '320px', bottom: '40px' }}>
      <CanvasToolbar />
      ...
      >
        ...
        <DragOverlay>
          {draggedElement && (
            <div
              className="opacity-60 bg-blue-200 border-2 border-blue-400 rounded-lg flex items-center justify-center"
              style={{
      ...
      {/* Help overlay */}
      <div className="absolute bottom-4 right-4 bg-white bg-opacity-90 backdrop-blur-sm rounded-lg px-3 py-2 text-xs text-gray-600" style={{ right: '340px' }}>
