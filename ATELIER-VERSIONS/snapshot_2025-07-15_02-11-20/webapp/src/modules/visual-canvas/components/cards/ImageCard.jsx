    ...
    >
      {data.src ? (
        ...
        <>
          ...
          {/* Image info */}
          {data.name && (
            <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-60 dark:bg-gray-900 dark:bg-opacity-80 text-white text-xs p-2 truncate">
              {data.name}
            </div>
          )}
        </>
        ...
        <div
          className={`w-full h-full flex flex-col items-center justify-center p-4 border-2 border-dashed transition-colors ${
            dragActive ? 'border-blue-500 bg-blue-50 dark:bg-blue-900' : 'border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800'
          }`}
        >
          {isLoading ? (
            <motion.div
            ...
            <>
              <Image size={32} className="text-gray-400 dark:text-gray-500 mb-2" />
              ...
              <div className="flex space-x-2">
                <button
                  onClick={() => fileInputRef.current?.click()}
                  className="px-3 py-1 bg-blue-500 dark:bg-blue-600 text-white text-xs rounded hover:bg-blue-600 dark:hover:bg-blue-500 transition-colors"
                >
                  Upload
                </button>
                <button
