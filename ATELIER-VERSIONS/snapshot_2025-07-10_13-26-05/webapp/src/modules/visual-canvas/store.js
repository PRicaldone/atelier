...
export const useCanvasStore = create(
  subscribeWithSelector((set, get) => ({
    ...
    moveElementToBoard: (element, targetBoardId) => {
      ...
      // Trigger tree refresh by updating a timestamp or similar
      // This forces HoudiniTreeView to re-read the hierarchy
      set((state) => ({
        selectedIds: [],
        // Force tree update
        lastUpdate: Date.now()
      ...
      // Force refresh of hierarchical data
      setTimeout(() => {
        // Trigger any components that depend on the hierarchy to refresh
