...
**Data:** 11/07/2025 16:54
**Ultimo commit:** aa76a6e 🎯 Fix Tree→Canvas drag&drop - addCompleteElement method + board-to-board enabled
**Branch:** main
**Commit totali:** 39
**Snapshots:** 32 | **Backups:** 0

**Ultima modifica:** 🎯 Fix Tree→Canvas drag&drop - addCompleteElement method + board-to-board enabled
