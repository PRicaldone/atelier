...
const PathBreadcrumb = () => {
  const { getBreadcrumbs, enterBoard, exitBoard, currentBoardId, boardHistory } = useCanvasStore();
  ...
  useEffect(() => {
    ...
    console.log('PathBreadcrumb updated - currentBoardId:', currentBoardId, 'breadcrumbs:', newBreadcrumbs.length);
  }, [currentBoardId, boardHistory, getBreadcrumbs]);
