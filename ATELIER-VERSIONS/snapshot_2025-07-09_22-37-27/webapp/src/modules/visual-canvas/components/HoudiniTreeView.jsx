  ...
  const getElementIcon = (type, element, isExpanded = false) => {
    ...
    switch (type) {
      case ELEMENT_TYPES.BOARD:
        ...
        return (
          <div className="flex items-center space-x-1">
            {hasElements ? (
              isExpanded ? <FolderOpen {...iconProps} className="text-blue-600" /> : <Folder {...iconProps} className="text-blue-600" />
            ) : (
              <Square {...iconProps} className="text-gray-400" />
            )}
            {hasElements && (
      ...
      case ELEMENT_TYPES.NOTE:
        return <StickyNote {...iconProps} className="text-yellow-500" />;
      case ELEMENT_TYPES.IMAGE:
        return <Image {...iconProps} className="text-green-500" />;
      case ELEMENT_TYPES.LINK:
        return <Link {...iconProps} className="text-blue-400" />;
    ...
    <div className="fixed right-0 top-16 bottom-0 w-80 bg-white border-l border-gray-200 shadow-lg z-40">
      ...
      <div className="px-4 py-3 border-b border-gray-200 bg-gray-50">
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-semibold text-gray-800">Canvas Network</h3>
          <div className="flex items-center space-x-2">
