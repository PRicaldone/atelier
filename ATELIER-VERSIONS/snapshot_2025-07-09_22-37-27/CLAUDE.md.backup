...
**Data:** 09/07/2025 19:36
**Ultimo commit:** 210b013 🧭 Fix breadcrumb sync: implementato navigateToBoard() per path corretto da tree navigation
**Branch:** main
**Commit totali:** 22
**Snapshots:** 16 | **Backups:** 0

**Ultima modifica:** 🧭 Fix breadcrumb sync: implementato navigateToBoard() per path corretto da tree navigation
