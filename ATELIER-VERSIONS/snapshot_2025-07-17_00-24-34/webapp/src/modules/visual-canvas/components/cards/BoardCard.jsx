...
export const BoardCard = ({ element }) => {
  ...
  // Milanote-style pastel colors with dark mode support
  const getMilanoteColor = () => {
    
    const colorMap = {
      '#F5F5F5': { light: '#F5F5F5', dark: '#374151' }, // Gray
      '#E3F2FD': { light: '#E3F2FD', dark: '#1E3A8A' }, // Blue
      '#F3E5F5': { light: '#F3E5F5', dark: '#581C87' }, // Purple
      '#E8F5E9': { light: '#E8F5E9', dark: '#166534' }, // Green
      '#FFF9C4': { light: '#FFF9C4', dark: '#92400E' }, // Yellow
      '#FFE0B2': { light: '#FFE0B2', dark: '#C2410C' }, // Coral
      '#FCE4EC': { light: '#FCE4EC', dark: '#BE185D' }, // Pink
      '#E0F7FA': { light: '#E0F7FA', dark: '#0E7490' }, // Cyan
      '#FFF3E0': { light: '#FFF3E0', dark: '#C2410C' }, // Orange
      '#E0F2F1': { light: '#E0F2F1', dark: '#0F766E' }, // Teal
    };
    
    const backgroundColor = element.data.backgroundColor || '#F5F5F5';
    const colorEntry = colorMap[backgroundColor];
      ...
      >
        ...
        <div className="flex items-center justify-between p-4">
            ...
            <div className="flex-1">
              ...
              {isEditing ? (
                <input
                  ...
                  className="w-full text-base font-medium bg-transparent border-none outline-none text-gray-800 dark:text-gray-200"
                  placeholder="Board title..."
                />
              ) : (
                <h3 
                  className="text-base font-medium text-gray-800 dark:text-gray-200 cursor-text"
                ...
                {isEditingDescription ? (
                  <div className="w-full">
                    <textarea
                      ...
                      className="w-full text-xs text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded p-2 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 resize-none overflow-hidden"
                    ...
                    />
                    <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">Click outside to save • Esc to cancel</div>
                  </div>
                ) : (
                  <div 
                    className={`text-xs cursor-text leading-tight ${
                      element.data.description ? 'text-gray-600 dark:text-gray-400' : 'text-gray-400 dark:text-gray-500 italic'
                    }`}
          ...
          <motion.button
            ...
            className="p-1.5 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-400 hover:bg-white/50 dark:hover:bg-gray-800/50 rounded-lg transition-colors"
            title="Board options"
          >
        ...
        <div className="px-4 pb-4">
          ...
          <div className="mt-3 flex space-x-1">
            ...
            <div className="h-1 w-6 bg-gray-300 dark:bg-gray-600 rounded-full" />
          </div>
        </div>
      </div>
