...
export const BoardCard = ({ element }) => {
  ...
  return (
    ...
    >
      {/* Milanote-style card */}
      <div 
        className="h-full w-full rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden"
        style={{ 
                ...
                {isEditingDescription ? (
                  <div className="w-full">
                    <textarea
                      ...
                      className="w-full text-sm text-gray-700 bg-white border border-gray-300 rounded p-2 focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                  ...
                  <p 
                    className={`text-sm cursor-text leading-tight whitespace-pre-wrap ${
