        ...
        >
          ...
          {Object.entries(modules).map(([key, module]) => (
            <div
              ...
              onClick={() => {
                if (hoveredModule === key && module.projects.length > 0) {
                  setActiveProject(module.projects[0].title);
                }
              }}
            >
              {/* Module Icon */}
          ...
          <div 
            style={{
              ...
              pointerEvents: 'none',
              opacity: 0,
              animation: 'fadeInScale 1s ease-out 1.2s forwards, gentlePulse 4s ease-in-out 2.2s infinite'
            }}
          >
            <p style={{
              fontFamily: 'Playfair Display, serif',
