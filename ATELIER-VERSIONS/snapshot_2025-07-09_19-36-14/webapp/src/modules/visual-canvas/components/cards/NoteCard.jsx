...
export const NoteCard = ({ element }) => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between p-2 border-b border-current opacity-20">
        <Type size={14} />
      ...
      {!isEditing && (
        ...
        >
          <Edit3 size={12} className="text-current opacity-60" />
        </motion.div>
      )}

      {/* Color palette indicator */}
      <div className="absolute bottom-2 right-2 w-3 h-3 rounded-full border border-current opacity-30" />
